...
public class AMBCReserva extends JFrame {
	...
	public AMBCReserva() {
		...
		cboTipos.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				
			}
		});
		cboTipos.setModel(this.loadtipos());
		cboTipos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String itemActual = cboTipos.getSelectedItem().toString();
				cboElementos.setModel(this.loadElementos(itemActual));
			}

			private ComboBoxModel loadElementos(String tipoel) {
					DefaultComboBoxModel categorias = new DefaultComboBoxModel();
					for (int i = 0; i < ctrlelemento.getElementos(tipoel).size(); i++){
						categorias.addElement(ctrlelemento.getElementos(tipoel).get(i).getNombre());}
					return categorias;}
			}
		);
		...
		cboElementos.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
			}
		});
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addComponent(txtDescripcion, 98, 98, 98)
							.addGap(173))
						.addGroup(gl_contentPane.createSequentialGroup()
						...
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
								...
								.addComponent(txtNombre, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE))
							.addContainerGap())
	...
	public DefaultComboBoxModel loadtipos() { //ESTAMOS TENIENDO ALGUN PROBLEMA CON ESTE METODO
